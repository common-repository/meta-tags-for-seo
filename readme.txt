...
META TAGS for SEO allows you to display custom META Keywords strategically (based on Yoast / Rank Math in some cases) to boost your ranking on search engines.
...
**According to John Mueller (2017):**[_Meta Tags_](https://en.wikipedia.org/wiki/Meta_element) _can affect the way that users see your site in the search results and whether or not they actually click through to your site._
...
For example, Yandex ([META TAGS that Yandex takes into account](https://yandex.com/support/webmaster/controlling-robot/html.html)) and Baidu use the meta keywords element to determine the page&#39;s relevance to search queries.
...
1. Unzip all files to the `/wp-content/plugins/meta-tags-for-seo` directory
2. Log into WordPress admin and activate the 'Meta Tags for SEO' plugin through the 'Plugins' menu
3. Go to "Meta Tags for SEO" in the left-hand menu to start work on it.
...
1. Meta Tags for SEO Settings Page
2. Meta Tags for SEO Settings Page
...
= 1.0.1 =
* 🐛 FIX: Some text and metabox screenshot
...
= 1.1.0 =
* 🔥 NEW: WooCommerce SKU, Categories & Tags (Pro)
* 👌 IMPROVE: Freemius SDK v2.5.2
* 👌 IMPROVE: Code structure

= 1.1.1 =
* 🐛 FIX: Security issue nonce
* 👌 IMPROVE: Updated Freemius SDK to v2.5.3
